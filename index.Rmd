...
In April 2020, one month after COVID-19 was declared a national emergency, the National Center for Health Statistics (NCHS) teameddd up with the Census Bureau to create the Household Pulse Survey, a 20 minute survey intended to record the impact of the pandemic on mental health.

For cleaning, the data required all dates be converted to Lubridate "Date" types from the original "Character". Confidence intervals were split into upper and lower bounds.
