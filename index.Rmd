...
Initially we were curious whether there was any the pandemic and circumstances around it could have had impact on the incidence of anxiety, depression, or other emotional disorders. After finding the Pulse Survey, we also wondered how mental health changed 
...
The "Value" column represents the percentage of members of the subgroup column that, at the time of measurement,  screened positive for symptoms of a depressive or anxious disorder, or both.
...
head_ad = anxiety_depression_df %>% 
  select(indicator, state, subgroup, time_period_end_date,value)
...
## Discussion:
We found that compared to last year, positive screening for anxiety is up X%, depression up Y%, and that screening for these seemed to peak around the same times as peak COVID mortality. 

And among states and age groups, there were significant differences in access to mental healthcare
