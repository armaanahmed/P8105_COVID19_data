...
For cleaning, the data required all dates be converted to Lubridate "Date" types from the original "Character", and columns converted to factors as necessary.
