...
We notice that there are distinct patterns of 
...
g = ggplot() + 
  ...
  labs(x = "Month", y = "% without access to mental health treatment",title = "Use of  ")
ggplotly(g)
...
And again for positive screening for anxiety or depression by state:

```{r}
anova_state_ax = aov(value ~factor(subgroup), data = mh_state_df)
