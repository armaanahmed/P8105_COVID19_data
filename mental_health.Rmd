...
ggplotly(p)
# 
# + geom_label(x = "Month", y = "% of Subgroup affected, COVID")
# + geom_label(x = "Month", y = "% of Subgroup affected, COVID mortality in tens of thosuands")

#With COVID Deaths, unfaceted
g = ggplot() + 
